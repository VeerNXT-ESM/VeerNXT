...
export const PaymentPage: React.FC = () => {
  ...
  const [status, setStatus] = useState<'loading' | 'active' | 'success' | 'error' | 'cancelled'>('loading');
...
// CSS keyframe spin injection (safely handled by custom style element or inline class)
